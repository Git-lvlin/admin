...
export const cityAgentManage = async (params = {}, options = {}) => {
  ...
  export const cityAgentHydrogenLeaseComm = async (params = {}, options = {}) => {
    const { current, pageSize,dateRange, ...rest } = params;
    const res = await request('/auth/java-admin/report/config/cityAgentHydrogenLeaseComm', {
      method: 'POST',
      data: {
        page: current,
        size: pageSize,
  ...
  export const cityAgentHydrogenLeaseCommStats = async (params = {}, options = {}) => {
    const res = await request('/auth/java-admin/report/config/cityAgentHydrogenLeaseCommStats', {
        method: 'POST',
        data:params,
        ...options
    });
