export default {
  ...
  'menu.order-management.normal-order-purchase': '普通订单',
  ...
  'menu.order-management.intensive-order.supplier-order-purchase': '集约批发订单',
  ...
  'menu.product-management.product-list-purchase': '商品列表',
