  ...
  useEffect(() => {
    ...
    setColumns([
      ...
      },
      {
        ...
        hideInTable: goodsSaleType === 2,
        render: (_,record) => {
          return record.distributePrice > 0 ? `${+new Big(record.distributePrice).minus(wholesaleFreight / 100).times(0.95).minus(record.wholesaleSupplyPrice).toFixed(2) }元/${unit}` : '-'
        }
      },
      {
        title: `分享补贴价平台毛利`,
