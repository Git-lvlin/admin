...
import { provinceAgentStorePm, provinceAgentStoreSt } from '@/services/great-health-province/health-store-partner-order-performance'
      ...
      <ProTable
        ...
        search={{
          optionRender: (searchConfig, formProps, dom) => [
            ...
            <Export
              key='export'
              type='provinceAgentStorePmDetail'
