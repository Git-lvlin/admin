...
import { hpaAedTrain,hpaAedTrainStats } from "@/services/great-health-province/aed-training-service-achievement"
  ...
  return (
    <PageContainer title={false}>
      <Descriptions labelStyle={{fontWeight:'bold'}} style={{background:'#fff'}} column={9} layout="vertical" bordered>
        <Descriptions.Item  label="大健康省代总数量">{detailList?.totalNum}  </Descriptions.Item>
