...
import { newWholesaleOperationPm, newWholesaleOperationPmStats } from "@/services/operation-management/new-intensive-performance"
  ...
  return (
    <PageContainer className={styles.desc}>
      <ProTable
        ...
        request={newWholesaleOperationPm}
        formRef={form}
        pagination={{
