...
import { cityAgencyGoodsSettlementOrder } from "@/services/city-office-management/goods-settlement"
...
const Detail: FC<DetailProps> = ({id, visible, setVisible, title, totalAmount}) => {
  ...
  useEffect(()=>{
    ...
    setLoad(true)
    cityAgencyGoodsSettlementOrder({
      agencyId: id,
            ...
            submitter={{
              render: ({form})=> [
                <Space size={10} key='1' className={styles.search}>
                  ...
                  <Export type="cityAgencyGoodsSettlementOrderDetail" conditions={getFieldsValue} key='export'/>
                </Space>
              ]
            }}
          >
