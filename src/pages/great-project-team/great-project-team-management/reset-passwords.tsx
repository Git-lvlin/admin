...
export default (props) => {
  ...
  return (
    <ModalForm
      title={`请确认要重置大团队长：${msgDetail?.manager}（账号：${msgDetail?.accountName}）的登录密码？`}
      ...
      submitter={{
        render: (props, defaultDoms) => {
            return [
            <span style={{display:'inline-block',marginRight:'330px',color:'#979797'}}>重置密码将同步发送给大团队长：{msgDetail?.manager}</span>,
            ...defaultDoms
            ];
        },
      }}
